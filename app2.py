...
def solve2(model_name: str, commands : str = Query(None), view_name : str = Query(None) ):
    """ Do FBA.
...
def save2(model_name: str, commands: str, author: str, new_model_name: str, view_name : str = Query(None) ):
    """ Save user model.
